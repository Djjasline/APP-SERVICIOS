...
const BodegaItemNew = lazy(() => import("./app/operaciones/bodega/BodegaItemNew"));
const BodegaItemDetail = lazy(() => import("./app/operaciones/bodega/BodegaItemDetail"));
const ClientesHome = lazy(() => import("./app/operaciones/clientes/ClientesHome"));
...
const ProtocoloManHome = lazy(() => import("./app/operaciones/protocoloMan/ProtocoloManHome"));
const ProtocoloManForm = lazy(() => import("./app/operaciones/protocoloMan/ProtocoloManForm"));
      ...
      <Suspense fallback={<div className="p-6 text-sm text-slate-500">Cargando...</div>}>
        <Routes>
          ...
          >
            ...
            <Route path="/inspeccion/barredora-piquersa-ba-2300h/new" element={<VehiculosRoute><HojaInspeccionBarredora variant="piquersaBa2300h" /></VehiculosRoute>} />
            <Route path="/inspeccion/barredora-piquersa-ba-2300h/ver/:id" element={<VehiculosRoute><RecordPermissionRoute action="view" fallback="/vehiculos/inspeccion"><InspeccionBarredoraPDF variant="piquersaBa2300h" allowDownload={false} /></RecordPermissionRoute></VehiculosRoute>} />
            <Route path="/inspeccion/barredora-piquersa-ba-2300h/:id" element={<VehiculosRoute><RecordPermissionRoute action="edit" fallback="/vehiculos/inspeccion"><HojaInspeccionBarredora variant="piquersaBa2300h" /></RecordPermissionRoute></VehiculosRoute>} />
            ...
            <Route path="/vehiculos/inspeccion/barredora-piquersa-ba-2300h/new" element={<VehiculosRoute><HojaInspeccionBarredora variant="piquersaBa2300h" /></VehiculosRoute>} />
            <Route path="/vehiculos/inspeccion/barredora-piquersa-ba-2300h/ver/:id" element={<VehiculosRoute><RecordPermissionRoute action="view" fallback="/vehiculos/inspeccion"><InspeccionBarredoraPDF variant="piquersaBa2300h" allowDownload={false} /></RecordPermissionRoute></VehiculosRoute>} />
            <Route path="/vehiculos/inspeccion/barredora-piquersa-ba-2300h/:id" element={<VehiculosRoute><RecordPermissionRoute action="edit" fallback="/vehiculos/inspeccion"><HojaInspeccionBarredora variant="piquersaBa2300h" /></RecordPermissionRoute></VehiculosRoute>} />
            ...
            <Route path="/mantenimiento/barredora-piquersa-ba-2300h/new" element={<VehiculosRoute><HojaMantenimientoBarredora variant="piquersaBa2300h" /></VehiculosRoute>} />
            <Route path="/mantenimiento/barredora-piquersa-ba-2300h/ver/:id" element={<VehiculosRoute><RecordPermissionRoute action="view" fallback="/vehiculos/mantenimiento"><MantenimientoBarredoraPDF variant="piquersaBa2300h" allowDownload={false} /></RecordPermissionRoute></VehiculosRoute>} />
            <Route path="/mantenimiento/barredora-piquersa-ba-2300h/:id" element={<VehiculosRoute><RecordPermissionRoute action="edit" fallback="/vehiculos/mantenimiento"><HojaMantenimientoBarredora variant="piquersaBa2300h" /></RecordPermissionRoute></VehiculosRoute>} />
            ...
            <Route path="/vehiculos/mantenimiento/barredora-piquersa-ba-2300h/new" element={<VehiculosRoute><HojaMantenimientoBarredora variant="piquersaBa2300h" /></VehiculosRoute>} />
            <Route path="/vehiculos/mantenimiento/barredora-piquersa-ba-2300h/ver/:id" element={<VehiculosRoute><RecordPermissionRoute action="view" fallback="/vehiculos/mantenimiento"><MantenimientoBarredoraPDF variant="piquersaBa2300h" allowDownload={false} /></RecordPermissionRoute></VehiculosRoute>} />
            <Route path="/vehiculos/mantenimiento/barredora-piquersa-ba-2300h/:id" element={<VehiculosRoute><RecordPermissionRoute action="edit" fallback="/vehiculos/mantenimiento"><HojaMantenimientoBarredora variant="piquersaBa2300h" /></RecordPermissionRoute></VehiculosRoute>} />
          ...
          <Route path="/inspeccion/barredora-piquersa-ba-2300h/:id/pdf" element={<ProtectedRoute><VehiculosRoute><RecordPermissionRoute action="download" fallback="/vehiculos/inspeccion"><InspeccionBarredoraPDF variant="piquersaBa2300h" /></RecordPermissionRoute></VehiculosRoute></ProtectedRoute>} />
          ...
          <Route path="/vehiculos/inspeccion/barredora-piquersa-ba-2300h/:id/pdf" element={<ProtectedRoute><VehiculosRoute><RecordPermissionRoute action="download" fallback="/vehiculos/inspeccion"><InspeccionBarredoraPDF variant="piquersaBa2300h" /></RecordPermissionRoute></VehiculosRoute></ProtectedRoute>} />
          ...
          <Route path="/mantenimiento/barredora-piquersa-ba-2300h/:id/pdf" element={<ProtectedRoute><VehiculosRoute><RecordPermissionRoute action="download" fallback="/vehiculos/mantenimiento"><MantenimientoBarredoraPDF variant="piquersaBa2300h" /></RecordPermissionRoute></VehiculosRoute></ProtectedRoute>} />
          ...
          <Route path="/vehiculos/mantenimiento/barredora-piquersa-ba-2300h/:id/pdf" element={<ProtectedRoute><VehiculosRoute><RecordPermissionRoute action="download" fallback="/vehiculos/mantenimiento"><MantenimientoBarredoraPDF variant="piquersaBa2300h" /></RecordPermissionRoute></VehiculosRoute></ProtectedRoute>} />
