...
const TIPOS = [
  ...
  { value: "inspeccion:barredora-piquersa-ba-2300h", label: "Inspección - Barredora Piquersa BA-2300-H" },
  ...
  { value: "mantenimiento:barredora-piquersa-ba-2300h", label: "Mantenimiento - Barredora Piquersa BA-2300-H" },
    ...
    <div className="space-y-6">
      ...
      <form onSubmit={handleSpecialModuleSubmit} className={`${cardClass} rounded-2xl p-5 shadow space-y-4`}>
        <div>
          ...
          <p className={`text-sm ${isLight ? "text-slate-600" : "text-white/70"}`}>
            Acceso directo a módulos especiales: configurador, cotizador, recorrido de agua, encuestas y bodega.
          </p>
        </div>
