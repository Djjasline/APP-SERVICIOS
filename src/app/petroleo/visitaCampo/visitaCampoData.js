export const defaultVisitaCampoData = {
  ...
  intervalosTabla:
    "Parte\tAPI 610\tANSI B73.1\nCojinetes / rodamientos\t8.000 - 12.000 horas (1 - 1.5 años)\t17.500 - 25.000 horas (2 - 3 años)\nSellos mecánicos\t12.000 - 16.000 horas (1.5 - 2 años)\t12.000 - 18.000 horas según fluido\nAnillos de desgaste\t8.000 - 16.000 horas (1 - 2 años)\tInspección anual / cambio por holgura\nImpulsor\tInspección cada 12.000 a 24.000 horas\tCondicional (3 - 5 años)\nEjes y camisas de eje\tInspección cada 12.000 a 24.000 horas\tCada 2 cambios de sello",
  notaIntervalos:
    "La periodicidad de los intervalos de mantenimiento se encuentra ligada a la severidad del servicio, las propiedades fisicoquímicas del fluido y la estabilidad operativa de cada equipo. Los valores presentados son referenciales y deberán ajustarse conforme a las condiciones reales de servicio.",
  conclusiones: [
