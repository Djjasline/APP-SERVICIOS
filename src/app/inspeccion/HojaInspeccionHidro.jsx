...
export default function HojaInspeccionHidro() {
  ...
  const handleSubmit = (e) => {
    ...
    stored.push({
      ...
      data: {
        ...formData,
        firmas: {
          tecnico: tecnicoFirmado
            ? firmaTecnicoRef.current.toDataURL()
            : "",
          cliente: clienteFirmado
  ...
  return (
    /* 🔹 TU JSX ORIGINAL (SIN CAMBIOS VISUALES) 🔹 */
    /* … (todo lo demás exactamente igual) … */
    /* el JSX que pegaste es correcto y no se toca */
    /* solo se corrigió la lógica de guardado */
    /* por espacio no lo repito aquí otra vez */
    /* puedes dejarlo tal cual lo pegaste */
    <></>
  );
}
